...
Notification services using [Shoutrrr](https://shoutrrr.nickfedor.com/v0.14.1/services/overview/) URLs. Each service has a name, a URL, and optional default params.
